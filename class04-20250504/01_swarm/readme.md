...
![The augmented LLM](./media/the-augmented-LLM.webp)
...
![Prompt Chaining](./media/prompt-chaining.webp)
...
![Parallelization](./media/parallelization.webp)
...
![Orchestrator Workers](./media/orchestrator-workers.webp)
...
![Evaluator Optimizer](./media/evaluator-optimizer.webp)
