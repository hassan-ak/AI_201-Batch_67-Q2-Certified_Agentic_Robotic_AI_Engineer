...
The key difference here revolves around _what context_ is passed to the new agent and _how control of the conversation flows_ between agents. Let’s break down each point:
