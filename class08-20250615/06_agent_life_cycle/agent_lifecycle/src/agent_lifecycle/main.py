...
from agent_lifecycle.my_secrets import Secrets
from rich import print
from rich.panel import Panel
from rich.markdown import Markdown
from dataclasses import dataclass
from agent_lifecycle.runner_hooks import ExampleRunnerHooks
import random
from agent_lifecycle.agent_hooks import CustomAgentHooks
...
agent = Agent[UserInfo](
    ...
    model=secrets.gemini_api_model,
    tools=[random_number],
    hooks=CustomAgentHooks(display_name="Starting Agent"),
)
